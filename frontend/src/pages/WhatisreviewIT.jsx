      ...
      <Container>
        ...
        >
          ...
          <Grid item xs={12} mt={1} >
            <Typography variant='h7' color={"#fafafa"} sx={{ fontSize: "1.2rem" }}>
              {" "}
              A tool that automatically reviews your paper to identify its
              strengths and weaknesses similar to the way a reviewer does.
            </Typography>
          </Grid>
          {/* {!isSmallScreen && (
      <Grid item xs={12} mt={1}>
