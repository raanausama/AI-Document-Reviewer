  ...
  const questions = [
    {
      ...
      answer:
        "Your paper/manuscript will never leave our servers. We prioritize the security and privacy of your data over everything else.",
    },
    {
      question: "What AI models does ReviewMyPaper use?",
      answer:
        "We use a variety of AI and generative AI models. However, rest assured, we do not use customers' data to train or retrain our AI models.",
    },
    {
      question: "Why is there no free trial?",
      answer:
        "Financial gain is not the primary objective behind developing this tool. We developed this tool to help researchers, especially PhD students, evaluate the quality of their papers. Charging a nominal fee helps us to run our services.",
    },
    {
      question: "How to contact the team behind ReviewMyPaper?",
      answer:
        "You can contact us by sending an email to customersupport@zaytrics.com.",
    },
  ];
